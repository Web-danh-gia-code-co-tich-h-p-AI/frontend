...
const buttonBaseClass = "inline-block bg-blue-600 text-white py-2 px-6 rounded-lg hover:bg-blue-700 transition-colors";
...
const ServiceCard = ({ title, description, imageUrl }) => {
    return (
        <div className="p-4 text-white bg-white rounded-lg shadow-lg dark:bg-zinc-700">
            <img src={imageUrl} alt={title} className="h-[200px] w-[300px] rounded-lg " />
    ...
    return (
        <main className={`${containerClass} px-4`}>
            <section id="hero" className="mt-8 text-center">
                ...
                <a href="#services" className={`${buttonBaseClass} mt-4`}>Explore Services</a>
            </section>

            <section id="services" className="mt-12">
                <h3 className={sectionTitleClass}>Các tiện ích chính</h3>
                <div className="grid grid-cols-1 gap-6 mt-6 md:grid-cols-2 lg:grid-cols-3">
                    <ServiceCard title="Tạo code trực tiếp" description="Bạn có thể trực tiếp viết code trên trang của chúng tôi và đánh giá chúng bằng AI." imageUrl="https://thumbs.dreamstime.com/b/compile-concept-random-parts-program-code-programming-abstract-technology-background-software-developer-computer-153537342.jpg" />
                    <ServiceCard title="Upload File code của bạn" description="Bạn có thể tải lên file code của bạn để AI có thể đánh giá khách quan cho bạn." imageUrl="https://www.verduins.com/wp-content/uploads/2014/12/bigstock-Hand-Press-Upload-Button-On-Ke-102346865-300x200.jpg" />
                    <ServiceCard title="Học sinh - Giáo viên" description="Web có chức năng dành cho cả học sinh và giáo viên" imageUrl="https://our.idtek.com.vn/content/images/2020/03/guide-to-wordpress-user-roles.png" />
                </div>
            </section>
