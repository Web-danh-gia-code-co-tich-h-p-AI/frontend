            ...
            <header className="w-full bg-main-black">
                <div className="container flex items-center justify-between px-4 py-4 mx-auto">
                    <div className="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-6 h-6 mr-2 text-white">
                        ...
                        <h1 className="text-lg font-semibold leading-6 text-white">Chấm Code tự động</h1>
                    </div>
                    <nav className="flex items-center" ref={menuRef}>
                        <div className="laptop:hidden">
                            <button onClick={toggleMenu} className="text-white bg-zinc-500 focus:outline-none">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                                    {isMenuOpen ? (
                                        <path fillRule="evenodd" d="M3 5h18v2H3V5ZM3 11h18v2H3v-2ZM3 17h18v2H3v-2Z" clipRule="evenodd" />
                                    ) : (
                                        <path fillRule="evenodd" d="M4 6h16v2H4V6Zm0 6h16v2H4v-2Zm0 6h16v2H4v-2Z" clipRule="evenodd" />
                                    )}
                                </svg>
                            </button>
                        </div>
                        <div className={`laptop:flex items-center ${isMenuOpen ? 'fixed right-0 top-0 bg-main-black h-full w-64 flex-col p-4' : 'hidden'}`}>
                            {/* <NavLink to="/" className="flex items-center p-2 mr-4 text-white rounded-lg hover:bg-zinc-400 hover:text-white">
                            ...
                            <NavLink to="/cham-diem" className="flex items-center p-2 mr-4 text-white rounded-lg hover:bg-zinc-400 hover:text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 mr-1">
                            ...
                            {/* <NavLink to="/dang-nhap" className="flex items-center p-2 text-white rounded-lg hover:bg-zinc-400 hover:text-white">
