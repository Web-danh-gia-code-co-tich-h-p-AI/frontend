...
const BlockXemCode = ({ onSendToForm }) => {
  ...
  return (
    <div className="w-full laptop:flex laptop:h-auto h-fit">
        ...
        <div className="h-full">
          ...
          {showDetail && selectedUser && (
            <div className="inset-0 flex items-center justify-center w-full bg-gray-800 bg-opacity-50 rounded-lg laptop:absolute">
              <div className="w-full h-full p-8 bg-white laptop:w-2/3 laptop:h-3/4 tablet:rounded-lg text-zinc-700">
                ...
                <div className="w-full h-full">
                  ...
                  <div className="flex justify-end">
                    ...
                    <button
                      ...
                      } px-4 py-2 ml-2 text-white bg-green-500 rounded-md hover:bg-green-600`}
                    >
      ...
      <div className="pt-2 mb-4 rounded-lg laptop:w-1/3 laptop:pl-6 text-zinc-800">
            ...
            <div>
                ...
                <ul className="mt-4">
                  {Object.entries(generatedValues).map(([key, value]) => (
                    <li key={key} className="mb-2">
                      <strong className="text-red-700 underline">{key}:</strong>{" "}
                      {value}
                    </li>
                  ))}
                </ul>
              ...
              <div className="flex justify-center mt-4">
                <button
                  ...
                  className="px-4 py-2 font-bold text-white transition duration-300 ease-in-out transform bg-blue-500 rounded hover:bg-blue-700 hover:scale-105 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50"
                >
                  {buttonText}
                </button>
              </div>
...
BlockXemCode.propTypes = {
  onSendToForm: PropTypes.func,
};

const EnhancedBlockXemCode = withErrorBoundary(BlockXemCode, {
  FallbackComponent,
});

export default EnhancedBlockXemCode;
