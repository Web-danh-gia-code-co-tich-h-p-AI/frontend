...
const BlockUpload = ({ generateContent }) => {
  ...
  return (
    <div className="w-screen p-4 border rounded-lg shadow-lg min-h-max laptop:w-1/2">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-6 mr-1 h-">
      ...
      <h2 className="flex text-lg font-semibold text-zinc-800">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-6 h-6 mr-1">
      ...
      <div className="items-center w-full mt-1 laptop:flex">
        ...
        <div className='flex justify-between mt-6 laptop:ml-12 laptop:flex laptop:mt-0'>
          <button 
            ...
            disabled={isLoading}
            className={`${commonPadding} ${commonRounded} bg-green-500 text-white hover:bg-green-600 hover:animate-pulse flex items-center ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
          >
            {isLoading ? (
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 mr-1 animate-spin">
              ...
              <path fillRule="evenodd" d="M4.5 13a3.5 3.5 0 0 1-1.41-6.705A3.5 3.5 0 0 1 9.72 4.124a2.5 2.5 0 0 1 3.197 3.018A3.001 3.001 0 0 1 12 13H4.5Zm.72-5.03a.75.75 0 0 0 1.06 1.06l.97-.97v2.69a.75.75 0 0 0 1.5 0V8.06l.97.97a.75.75 0 1 0 1.06-1.06L8.53 5.72a.75.75 0 0 0-1.06 0L5.22 7.97Z" clipRule="evenodd" />
              </svg>
            )}
